...
def extract_features(directory):
    ...
    for naam in names:
        ...
        for name in os.listdir(foldername):
            ...
            gcom = greycomatrix(feat_lbp, [1], [0], 256, symmetric=True, normed=True)
...
clf = ExtraTreesClassifier(n_estimators=250, n_jobs=-1, random_state= 0, max_leaf_nodes=1500, max_features='log2', oob_score=True, max_depth=15, min_samples_leaf=1, bootstrap=True)
