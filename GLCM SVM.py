...
#Classification using NuSVC and C-SVC
clf = svm.NuSVC(nu=0.25, kernel='rbf', gamma='scale', decision_function_shape='ovo', probability=True, class_weight='balanced', max_iter=-1, random_state=2)
