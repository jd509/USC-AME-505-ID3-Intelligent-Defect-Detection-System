...
clf = RandomForestClassifier(n_estimators=280, n_jobs=-1, random_state= 25, max_features='log2', max_leaf_nodes=1500, oob_score=True, max_depth=None, min_samples_leaf=1)
